...
export type ComponentProps<K extends TagNames> =
  & Omit<JSX.IntrinsicElements[K], "children" | "style">
  & DOMNodeAttributes<JSX.IntrinsicElements[K], K>
  & {
...
export namespace JSX {
  ...
  type ComponentProps<K extends keyof IntrinsicElements> = Omit<
    IntrinsicElements[K],
    "children"
  >;
  type Component<
    K extends keyof IntrinsicElements,
    O extends (Record<string, PropValueOrAccessor> | undefined) = undefined,
  > = (
    props?:
