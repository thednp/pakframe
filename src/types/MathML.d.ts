import type { DOMNodeAttributes, FunctionMaybe, MaybeChildNode } from "./types";
...
interface MathMLAttributes<T, K extends keyof MathMLElementTags>
  extends DOMNodeAttributes<T, K> {
...
interface MathMLAnnotationElementAttributes<T>
  extends MathMLAttributes<T, "annotation"> {
  encoding?: FunctionMaybe<string>;
  /** @deprecated */
  src?: FunctionMaybe<string>;
}
interface MathMLAnnotationXmlElementAttributes<T>
  extends MathMLAttributes<T, "annotation-xml"> {
  encoding?: FunctionMaybe<string>;
  /** @deprecated */
  src?: FunctionMaybe<string>;
}
interface MathMLMactionElementAttributes<T>
  extends MathMLAttributes<T, "maction"> {
  /**
   * @deprecated
   * @non-standard
   */
...
interface MathMLErrorElementAttributes<T>
  extends MathMLAttributes<T, "merror"> {}
...
interface MathMLMmultiscriptsElementAttributes<T>
  extends MathMLAttributes<T, "mmultiscripts"> {
  /**
   * @deprecated
   * @non-standard
   */
...
interface MathMLMpaddedElementAttributes<T>
  extends MathMLAttributes<T, "mpadded"> {
...
interface MathMLMphantomElementAttributes<T>
  extends MathMLAttributes<T, "mphantom"> {}
interface MathMLMprescriptsElementAttributes<T>
  extends MathMLAttributes<T, "mprescripts"> {}
interface MathMLMrootElementAttributes<T>
  extends MathMLAttributes<T, "mroot"> {}
...
interface MathMLMspaceElementAttributes<T>
  extends MathMLAttributes<T, "mspace"> {
  depth?: FunctionMaybe<string>;
  height?: FunctionMaybe<string>;
  width?: FunctionMaybe<string>;
}
interface MathMLMsqrtElementAttributes<T>
  extends MathMLAttributes<T, "msqrt"> {}
interface MathMLMstyleElementAttributes<T>
  extends MathMLAttributes<T, "mstyle"> {
  /**
   * @deprecated
   * @non-standard
   */
...
interface MathMLMsubsupElementAttributes<T>
  extends MathMLAttributes<T, "msubsup"> {
  /**
   * @deprecated
   * @non-standard
   */
...
interface MathMLMtableElementAttributes<T>
  extends MathMLAttributes<T, "mtable"> {
  /** @non-standard */
...
interface MathMLMtextElementAttributes<T>
  extends MathMLAttributes<T, "mtext"> {}
...
interface MathMLMunderElementAttributes<T>
  extends MathMLAttributes<T, "munder"> {
  accentunder?: FunctionMaybe<"" | boolean>;
}
interface MathMLMunderoverElementAttributes<T>
  extends MathMLAttributes<T, "munderover"> {
  accent?: FunctionMaybe<"" | boolean>;
  accentunder?: FunctionMaybe<"" | boolean>;
}
interface MathMLSemanticsElementAttributes<T>
  extends MathMLAttributes<T, "semantics"> {}
interface MathMLMencloseElementAttributes<T>
  extends MathMLAttributes<T, "menclose"> {
  /** @non-standard */
  notation?: FunctionMaybe<string>;
}
interface MathMLMfencedElementAttributes<T>
  extends MathMLAttributes<T, "mfenced"> {
