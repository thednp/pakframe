import { CSSProperties, ChildAccessor, ChildArray, DOMElement, DOMNodeAttributes, FunctionMaybe, MathMLElementTags, MaybeChildNode, OutputElement, PropValueOrAccessor, TagNames } from "./types-DVZQe0sT.cjs";
...
declare namespace JSX {
  // type Element = Primitive | DOMElement | ArrayElement | FunctionElement | (string & {});
  type Element = MaybeChildNode | (string & {});
  type ComponentProps<K extends keyof IntrinsicElements> = Omit<IntrinsicElements[K], "children">;
  type Component<K extends keyof IntrinsicElements, O extends (Record<string, PropValueOrAccessor> | undefined) = undefined> = (props?: (O extends object ? ComponentProps<K> & Partial<O> : ComponentProps<K>) & {
    children?: JSX.Element;
  }) => JSX.Element;
  interface ArrayElement extends Array<JSX.Element> {}
  ...
  type EventHandlerWithOptionsUnion<T, E extends Event> = EventHandler<T, E> | EventHandlerWithOptions<T, E>;
  ...
  interface AriaAttributes {
    ...
    /**
     * Indicates the current "checked" Accessor of checkboxes, radio buttons, and other widgets.
     *
     ...
     * elements.
     */
    "aria-current"?: FunctionMaybe<boolean | "false" | "true" | "page" | "step" | "location" | "date" | "time" | undefined>;
    /**
     ...
     */
    "aria-dropeffect"?: FunctionMaybe<"none" | "copy" | "execute" | "link" | "move" | "popup">;
    /**
    ...
    /**
     * Indicates an element's "grabbed" Accessor in a drag-and-drop operation.
     *
     * @deprecated In ARIA 1.1
     */
     ...
     */
    "aria-haspopup"?: FunctionMaybe<boolean | "false" | "true" | "menu" | "listbox" | "tree" | "grid" | "dialog">;
    /**
     ...
     */
    "aria-invalid"?: FunctionMaybe<boolean | "false" | "true" | "grammar" | "spelling">;
    /**
    ...
    /**
     * Indicates the current "pressed" Accessor of toggle buttons.
     *
     ...
     * @see aria-atomic.
     */
    "aria-relevant"?: FunctionMaybe<"additions" | "additions removals" | "additions text" | "all" | "removals" | "removals additions" | "removals text" | "text" | "text additions" | "text removals">;
    ...
    /**
     * Indicates the current "selected" Accessor of various widgets.
     *
  ...
  interface HTMLAttributes<T> extends AriaAttributes, DOMAttributes<T> {
    ...
    style?: FunctionMaybe<CSSProperties | string | null>;
  ...
  interface PresentationSVGAttributes {
    ...
    "pointer-events"?: FunctionMaybe<"bounding-box" | "visiblePainted" | "visibleFill" | "visibleStroke" | "visible" | "painted" | "color" | "fill" | "stroke" | "all" | "none" | "inherit">;
    ...
    "text-rendering"?: FunctionMaybe<"auto" | "optimizeSpeed" | "optimizeLegibility" | "geometricPrecision" | "inherit">;
...
declare const jsx: <K extends TagNames>(jsxTag: K | Component<K>, {
  children,
  style,
  ...rest
}: ComponentProps<K>) => string | number | bigint | boolean | symbol | SVGElement | MathMLElement | ChildArray | ChildAccessor | OutputElement<K> | null | undefined;
...
//# sourceMappingURL=jsx-CjxJnKVh.d.cts.map