...
const getStringValue = (child) => {
	...
	return t === "string" ? escape$1(child) : "number" === t || "boolean" === t || "bigint" === t || "symbol" === t || child instanceof Date || child instanceof RegExp ? child.toString() : String(child);
};
/**
...
const setAttribute = (element, key, rawValue) => {
	...
	if (value == null || value === false || value === "" || value === void 0) {
		...
		const attrValue = value === true ? "" : t === "number" ? String(value) : !urlAttributes.includes(key) ? (0, __thednp_domparser.escape)(value) : needsEncoding(key, value) ? encodeURI(value) : value;
...
const isHydrated = (target) => target.hasAttribute("data-h");
...
const CONTEXT_OWNER = { current: null };
function createOwner(parent = null) {
	return {
...
const provide = (contextSymbol, value) => {
...
Object.defineProperty(exports, 'CONTEXT_OWNER', {
  enumerable: true,
  get: function () {
...
//# sourceMappingURL=core-CfqC-T4D.cjs.map